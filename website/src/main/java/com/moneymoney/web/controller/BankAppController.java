...
public class BankAppController {
	...
	public String deposit(@ModelAttribute Transaction transaction, Model model) {
		...
		restTemplate.postForEntity("http://localhost:9095/transactions-client/transactions", transaction, null);
	...
	public String withdraw(@ModelAttribute Transaction transaction, Model model) {
		// System.out.println("transaction "+transaction);
		restTemplate.postForEntity("http://localhost:9095/transactions-client/transactions/withdraw", transaction, null);
		model.addAttribute("message", "Success!");
		return "WithdrawForm";
	}
	...
	public String fund(@RequestParam("senderAccountNumber") Integer senderAccountNumber,
		...
		restTemplate.postForEntity(
				"http://localhost:9095/transactions-client/transactions/transfer?receiverAccountnumber=" + receiverAccountnumber,
				transaction, null);
		model.addAttribute("message", "Success!!!");
		return "FundTransfer";
	}
	...
	public ModelAndView getStatementDeposit(@RequestParam("offset") int offset, @RequestParam("size") int size) {
		CurrentDataSet currentDataSet = restTemplate.getForObject("http://localhost:9095/transactions-client/transactions/statement",
